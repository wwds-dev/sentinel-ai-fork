...
BUILTIN_AGENTS = {
    ...
    "osint_heavy": {
        ...
        "tooltip": "Deep OSINT dossiers and read-only search in selected local folders.",
        "description": "Deep investigation dossiers plus private, user-directed local file discovery.",
        "allowed_tools": None,
        "budget_limit_eur": None,
    },
    "wifi": {
